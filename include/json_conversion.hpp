...
void to_json(json& j, const raylib::Rectangle& rect) {
    j = json{{"x", rect.GetX()}, {"y", rect.GetY()}, {"width", rect.width}, {"height", rect.height}};
}

void to_json(json& j, const raylib::Color& color) {
    j = json{{"r", color.r}, {"g", color.g}, {"b", color.b}, {"a", color.a}};
}

void from_json(const json& j, raylib::Rectangle& rect) {
...
void from_json(const json& j, raylib::Color& color) {
