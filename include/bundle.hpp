...
namespace basic
{
  ...
  constexpr void tuple_insert(const Tuple& tuple,
                              flecs::world& world,
                              flecs::entity_t e)
  {
  ...
  struct ComponentBundle
  {
    ...
    template <typename... OtherComponents>
    constexpr ComponentBundle<Components..., OtherComponents...> merge(
        const ComponentBundle<OtherComponents...>& other) const
    {
  ...
  template <typename... Components>
  using Bundle = ComponentBundle<Components...>;
  ...
  struct MergeBundles<ComponentBundle<Components...>,
                      ComponentBundle<OtherComponents...>,
                      OtherBundles...>
  {
    using Type = typename MergeBundles<
        ComponentBundle<Components..., OtherComponents...>,
        OtherBundles...>::Type;
  };
