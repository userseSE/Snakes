...
struct function_argument_types<F> : function_argument_types<decltype(&F::operator())> {};
...
template <typename F>
using function_argument_types_t = typename function_argument_types<std::decay_t<F>>::type;
